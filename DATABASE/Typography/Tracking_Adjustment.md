...
The final paragraph shall maintain natural character spacing and clear readability.

Tracking adjustment should make the right edge visually more balanced, but perfect mechanical alignment is not required.

When acceptable composition can be achieved with Tracking set to `0`, no adjustment shall be applied.
