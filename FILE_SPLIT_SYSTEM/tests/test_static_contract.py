...
class StaticContractTests(unittest.TestCase):
    def test_all_json_versions_and_settings_parse(self):
        ...
        self.assertEqual(settings["schema_version"], "1.4.0")
        self.assertEqual(settings["rule_version"], "1.4.0")
        ...
        for path in ROOT.rglob("*.json"):
            ...
            if "schema_version" in payload:
                self.assertEqual(payload["schema_version"], "1.4.0", str(path))
    ...
    def test_manifest_blocks_fast_production_until_real_validation(self):
        ...
        self.assertIn(manifest["executors"][0]["validation_status"], ("implemented_unverified", "verified"))
